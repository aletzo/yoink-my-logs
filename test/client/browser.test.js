...
describe("browser module exports", () => {
  ...
  test("has warn method", async () => {
    ...
    assert.strictEqual(
      typeof yoink.warn,
      "function",
      "yoink.warn should be a function"
    );
  });
  ...
  test("has error method", async () => {
    ...
    assert.strictEqual(
      typeof yoink.error,
      "function",
      "yoink.error should be a function"
    );
  });
  ...
  test("has debug method", async () => {
    ...
    assert.strictEqual(
      typeof yoink.debug,
      "function",
      "yoink.debug should be a function"
    );
  });
  ...
  test("has success method", async () => {
    const yoink = (await import("../../browser.js")).default;
    assert.strictEqual(
      typeof yoink.success,
      "function",
      "yoink.success should be a function"
    );
  });
  ...
  test("has init method", async () => {
    ...
    assert.strictEqual(
      typeof yoink.init,
      "function",
      "yoink.init should be a function"
    );
  });
...
describe("browser module array slicing exports", () => {
  test("has first method", async () => {
    ...
    assert.strictEqual(
      typeof yoink.first,
      "function",
      "yoink.first should be a function"
    );
  });
  ...
  test("has five method", async () => {
    ...
    assert.strictEqual(
      typeof yoink.five,
      "function",
      "yoink.five should be a function"
    );
  });
  ...
  test("has ten method", async () => {
    ...
    assert.strictEqual(
      typeof yoink.ten,
      "function",
      "yoink.ten should be a function"
    );
  });
  ...
  test("has last method", async () => {
    ...
    assert.strictEqual(
      typeof yoink.last,
      "function",
      "yoink.last should be a function"
    );
  });
  ...
  test("has last.five method", async () => {
    const yoink = (await import("../../browser.js")).default;
    assert.strictEqual(
      typeof yoink.last.five,
      "function",
      "yoink.last.five should be a function"
    );
  });
  ...
  test("has last.ten method", async () => {
    const yoink = (await import("../../browser.js")).default;
    assert.strictEqual(
      typeof yoink.last.ten,
      "function",
      "yoink.last.ten should be a function"
    );
  });
});
