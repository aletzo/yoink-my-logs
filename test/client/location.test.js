...
describe("getCallerInfo()", () => {
  ...
  test("relativePath shows short path (last 2 parts)", () => {
    ...
    assert.ok(parts.length <= 2, `relativePath should show at most 2 path parts, got: ${result.relativePath}`)
  })
})
