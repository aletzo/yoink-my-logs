...
yoink.first = (first, second) =>
  createSlicedLog(first, second, (data) => {
    if (!Array.isArray(data)) return data;
    if (data.length === 0) return undefined;
    return data[0];
  });
yoink.five = (first, second) =>
  createSlicedLog(first, second, (data) => sliceArray(data, 0, 5));
yoink.ten = (first, second) =>
  createSlicedLog(first, second, (data) => sliceArray(data, 0, 10));
...
yoink.last.five = (first, second) =>
  createSlicedLog(first, second, (data) => sliceFromEnd(data, 5));
yoink.last.ten = (first, second) =>
  createSlicedLog(first, second, (data) => sliceFromEnd(data, 10));
